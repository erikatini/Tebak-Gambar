...
public class BuangActivity extends Activity {
	EditText jawabanTxt;
	@Override
	...
	public void cekJawaban (View v){
    	String jawabanBenar = "BUANG SAMPAH";
    	...
    	Intent i = new Intent (getApplicationContext(),KebabActivity.class);
    	startActivity(i);
    	}
    	else{
    		//pesan Toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.buang, menu);
		return true;
	}
