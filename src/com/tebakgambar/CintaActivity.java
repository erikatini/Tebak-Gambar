...
public class CintaActivity extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
	 ...
	 public void cekJawaban (View v){
	    	String jawabanBenar = "CINTA SEGITIGA";
	    	...
	    	Intent i = new Intent (getApplicationContext(),TembokActivity.class);
	    	startActivity(i);
	    	}
	    	else{
	    		//pesan Toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.cinta, menu);
		return true;
	}
