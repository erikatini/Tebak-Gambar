...
public class NatalActivity extends Activity {
	EditText jawabanTxt;
	@Override
	...
	public void cekJawaban (View v){
    	String jawabanBenar = "SELAMAT HARI NATAL";
    	...
    	Intent i = new Intent (getApplicationContext(),JawabActivity.class);
    	startActivity(i);
    	}
    	else{
    		//pesan Toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.natal, menu);
		return true;
	}
