...
public class TembokActivity extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
	 ...
	 public void cekJawaban (View v){
	    	String jawabanBenar = "TEMBOK CINA";
	    	...
	    	Intent i = new Intent (getApplicationContext(),PedagangActivity.class);
	    	startActivity(i);
	    	}
	    	else{
	    		//pesan Toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.tembok, menu);
		return true;
	}
