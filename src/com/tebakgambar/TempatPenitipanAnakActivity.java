...
public class TempatPenitipanAnakActivity extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_tempat_penitipan_anak);
	...
	public void cekJawaban (View v){
    	String jawabanBenar = "TEMPAT PENITIPAN ANAK";
    	...
    	Intent i = new Intent (getApplicationContext(),NatalActivity.class);
    	startActivity(i);
    	}
    	else{
    		//pesan Toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.tempat_penitipan_anak, menu);
		return true;
	}
