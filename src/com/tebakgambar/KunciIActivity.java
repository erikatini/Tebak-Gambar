...
public class KunciIActivity extends Activity {
	EditText jawabanTxt;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_kunci_i);
	...
	public void cekJawaban (View v){
    	...
    	Intent i = new Intent (getApplicationContext(),TempatPenitipanAnakActivity.class);
    	startActivity(i);
    	}
    	else{
    		//pesan Toast
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.kunci_i, menu);
		return true;
	}
