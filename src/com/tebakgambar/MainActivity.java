...
public class MainActivity extends Activity {
    ...
    public void cekJawaban (View v){
    	...
    	Intent i = new Intent (getApplicationContext(),CintaActivity.class);
    	startActivity(i);
    	}
    	else{
    		//pesan Toast
